...
public class ReLogoObserver extends BaseObserver{
	...
	public AgentSet<cyberfit.relogo.InteractionFF> interactionFFs(){
		...
		for (Object e : this.getContext().getObjects(cyberfit.relogo.InteractionFF.class)) {
	...
	public cyberfit.relogo.InteractionFF interactionFF(Number oneEnd, Number otherEnd) {
		return (cyberfit.relogo.InteractionFF)(this.getNetwork("InteractionFF").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
	...
	public AgentSet<cyberfit.relogo.InteractionFT> interactionFTs(){
		...
		for (Object e : this.getContext().getObjects(cyberfit.relogo.InteractionFT.class)) {
	...
	public cyberfit.relogo.InteractionFT interactionFT(Number oneEnd, Number otherEnd) {
		return (cyberfit.relogo.InteractionFT)(this.getNetwork("InteractionFT").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
	...
	public AgentSet<cyberfit.relogo.InteractionTT> interactionTTs(){
		...
		for (Object e : this.getContext().getObjects(cyberfit.relogo.InteractionTT.class)) {
	...
	public cyberfit.relogo.InteractionTT interactionTT(Number oneEnd, Number otherEnd) {
		return (cyberfit.relogo.InteractionTT)(this.getNetwork("InteractionTT").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
